                ...
                <div class="col-lg-8">
                    ...
                    <div class="content-text mb-4"><?php
                            ...
                            <div class="text-center">
                                ...
                                if($nsc_email): 
                                    echo '<div class="content-text"><p class="mb-4"><b>Email:</b> <a class="blk-link" href="mailto:'.$nsc_email.'">'.$nsc_email.'</a></p></div>';
                                endif; ?>                                
                            </div><?php
